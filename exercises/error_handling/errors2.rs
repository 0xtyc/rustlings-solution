...
pub fn total_cost(item_quantity: &str) -> Result<i32, ParseIntError> {
    ...
    let cost_per_item = 5;
    let qty = item_quantity.parse::<i32>()?; // The ? operator will return the error if it is an error, otherwise it will return the value
    Ok(qty * cost_per_item + processing_fee)

    // The above two lines of code did the same thing as the below commented out code
